...
export async function POST(request: Request) {
  try {
    ...
    if (monetisationModel !== undefined) blueprintData.monetisation_model = monetisationModel;
    if (pricingStrategy !== undefined) blueprintData.pricing_strategy = pricingStrategy;
    if (offerPlan !== undefined) blueprintData.offer_plan = offerPlan;
    if (checkoutFlow !== undefined) blueprintData.checkout_flow = checkoutFlow;
    if (activationBlueprint !== undefined) blueprintData.activation_blueprint = activationBlueprint;
    if (monetisationAssets !== undefined) blueprintData.monetisation_assets = monetisationAssets;
    if (revenuePack !== undefined) blueprintData.revenue_pack = revenuePack;
