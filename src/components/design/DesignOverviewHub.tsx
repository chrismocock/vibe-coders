...
const DESIGN_SECTIONS = [
  ...
  },
  {
    ...
    icon: Package,
    description: "Product vision, features, and value delivery",
  },
  {
    id: "user_personas",
    label: "User Personas",
    icon: Users,
    description: "Target user profiles and behaviors",
  },
  {
    id: "user_journey",
    label: "User Journey",
    icon: Map,
    description: "User journey mapping and pain points",
  },
  {
    id: "information_architecture",
    label: "Information Architecture",
    icon: Layout,
    description: "Site map and navigation structure",
  },
  {
    id: "wireframes",
  ...
  },
  {
    ...
    icon: Target,
    description: "MVP features and release roadmap",
  },
  {
    id: "design_summary",
    label: "Design Summary & Export",
    icon: FileText,
    description: "Complete design blueprint and export",
  },
] as const;
